...
private:
    ...
    constexpr static SalarySys* m_pInstance = nullptr;
};
...
int main()
{
    ...
    Employee* pMax = pSalarySys1->GetMax();
    if(nullptr != pMax)
    {
        cout<<"工资最高的员工是："<<endl;
    ...
    // 使用pSalarySys1或SalarySys2释放这个对象是等效的，并且只需要释放一次
    delete pSalarySys1;
